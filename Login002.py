...
# Provide your own username, password should be blank.
...
#################### TEST CASE LOGIN002 #####################
# TEST CASE: LOGIN002
# DESCRIPTION: This test case will verify an error message when the password is left blank.
# ENTRANCE CRITERIA: Valid username added to variables in SETUP.
# EXIT CRITERIA: Error Message is received
#############################################################

now = datetime.now()
start_time = now.strftime("%H:%M:%S")
print ("*** Test case Login002 start time:", start_time)
...
print ("*** Test case Login002 end time:", end_time)
driver.close()
